...
namespace NavigationDrawer
{
	...
	public class MainActivity : ActivityBase
	{
		...
		Fragment [] fragments = new Fragment [] { new MailFragment (), new CalendarFragment (), new ContactsFragment ()};
		string [] titles = new string [] { "Mail", "Calendar", "Contacts" };
		...
		protected override void OnCreate (Bundle bundle)
		{
			...
			drawerListView.Adapter = new ArrayAdapter<string> (this, Resource.Layout.DrawerMenuRow, Resource.Id.drawerMenuRowTextView, titles);
